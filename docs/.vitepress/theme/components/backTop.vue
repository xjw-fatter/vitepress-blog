<template>
	<Transition name="fade">
		<div v-show="showBackTop" class="back-top" title="返回顶部" @click="utils.debounce(scrollToTop, 300)">
        ...
        <path d="M12 26L24 14L36 26" stroke="#fff" stroke-width="4" stroke-linecap="round" stroke-linejoin="miter" />
        <path d="M12 6H36" stroke="#fff" stroke-width="4" stroke-linecap="round" stroke-linejoin="miter" />
      </svg> -->
		</div>
	</Transition>
</template>
