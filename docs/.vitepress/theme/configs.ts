...
const defaultOptions: VitePressSidebarOptions = {
    ...
    // 标题处理
    hyphenToSpace: false, // 是否将标题中的连字符转换为空格
    underscoreToSpace: false, // 是否将标题中的下划线转换为空格
    capitalizeFirst: false, // 是否将标题的第一个字母大写
    capitalizeEachWords: false, // 是否将标题中的每个单词首字母大写
    // 文件和文件夹处理
